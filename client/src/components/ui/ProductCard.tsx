            ...
            <div className="p-5 flex flex-col flex-grow">
                ...
                <div className="mt-auto flex items-end justify-between">
                    ...
                    {user?.role === 'ADMIN' ? (
                        <Link
                            href="/admin/products"
                            className="px-3 py-2 bg-slate-800 text-neon-blue border border-neon-blue/30 rounded-lg text-[10px] font-black uppercase hover:bg-neon-blue/10 transition-all flex items-center gap-2"
                        >
